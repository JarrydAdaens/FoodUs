...
- Assumptions and constraints:
  ...
  - PII rule is constitutional: no `BigAnt` / `Big Ant` string may survive into any artifact.
...
- PII scan: `grep -i "bigant\|big ant"` over all changed files returns nothing.
